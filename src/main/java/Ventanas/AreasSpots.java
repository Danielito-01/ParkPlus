...
public class AreasSpots extends javax.swing.JDialog {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(AreasSpots.class.getName());
    ...
    private void initComponents() {
        ...
        tablaAreas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Nombre", "Capacidad total", "Tipo de vehiculo"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                AreasSpots dialog = new AreasSpots(new javax.swing.JFrame(), true);
